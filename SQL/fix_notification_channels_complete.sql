-- Script completo para corregir la tabla notification_channels
-- Maneja todos los campos requeridos: display_name, type, types, settings
...
-- Insertar canales de notificación por defecto con todos los campos
INSERT INTO public.notification_channels (name, display_name, description, type, types, settings, enabled) VALUES
('Sistema', 'Sistema', 'Notificaciones del sistema y alertas importantes', 'system', ARRAY['push', 'email'], '{"sound": true, "vibration": true, "badge": true, "priority": "high"}', true),
('Proyectos', 'Proyectos', 'Actualizaciones de proyectos y tareas', 'project', ARRAY['push', 'email'], '{"sound": true, "vibration": false, "badge": true, "priority": "normal"}', true),
('Equipo', 'Equipo', 'Notificaciones relacionadas con el equipo', 'team', ARRAY['push', 'email'], '{"sound": false, "vibration": true, "badge": true, "priority": "normal"}', true),
('Pagos', 'Pagos', 'Notificaciones de pagos y facturación', 'payment', ARRAY['push', 'email'], '{"sound": true, "vibration": true, "badge": true, "priority": "high"}', true),
('Marketing', 'Marketing', 'Promociones y actualizaciones de producto', 'marketing', ARRAY['email'], '{"sound": false, "vibration": false, "badge": false, "priority": "low"}', true);
