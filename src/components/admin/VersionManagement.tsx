      ...
      return (
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <Button onClick={reload} variant="outline" className="border-zinc-600 text-zinc-300 hover:bg-zinc-800">
              Reintentar
            </Button>
          </div>
        </div>
      ...
      <div className="p-4 sm:p-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex-1 min-w-0">
            <h2 className="text-xl sm:text-2xl font-bold text-white break-words">Gestión de Versiones</h2>
                         <p className="text-gray-400 text-sm sm:text-base">Control de versiones del proyecto</p>
          </div>
        ...
        <Tabs defaultValue="versions" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-zinc-800">
            ...
            <TabsTrigger value="activity" className="data-[state=active]:bg-blue-600 text-xs sm:text-sm">
                      ...
                      <div className="flex-1 min-w-0">
                       ...
                       <div className="flex flex-row sm:flex-col gap-2 sm:ml-4">
                        <Button
                          ...
                          size="sm"
                          variant="outline"
                           className="border-zinc-600 text-zinc-300 hover:bg-zinc-700 flex-1 sm:flex-none"
                        >
            ...
            <Card className="bg-zinc-800 border-zinc-700">
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  {/* Últimas versiones */}
                  <div>
                    <h4 className="text-md font-medium text-gray-300 mb-2">Últimas Versiones</h4>
                    <div className="space-y-2">
                      {versions.slice(0, 5).map((version) => (
                        <div key={version.id} className="flex items-center gap-3 p-3 bg-zinc-700 rounded">
        ...
        <Dialog open={showCreateVersion} onOpenChange={setShowCreateVersion}>
          <DialogContent className="bg-zinc-900 border-zinc-700 max-w-2xl max-h-[90vh] overflow-y-auto" aria-describedby="create-version-description">
            <DialogHeader>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {versionForm.changes.map((change, index) => (
                    <div key={index} className="flex items-start gap-2 p-3 bg-zinc-800 rounded">
                  ...
                  <div className="p-3 border border-dashed border-zinc-600 rounded">
                    <div className="grid grid-cols-2 gap-2 mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <Label htmlFor="breakingChange" className="text-sm">Breaking Change</Label>
                      </div>
                    </div>
        ...
        <Dialog open={showVersionDetails} onOpenChange={setShowVersionDetails}>
            <DialogContent className="bg-zinc-900 border-zinc-700 max-w-[95vw] lg:max-w-[90vw] xl:max-w-[85vw] 2xl:max-w-[80vw] max-h-[95vh] overflow-y-auto" aria-describedby="version-details-description">
            <DialogHeader>
            ...
            {selectedVersion && (
              <div className="space-y-6">
                {/* Header de la versión */}
                 <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between p-4 bg-zinc-800 rounded-lg gap-4">
                   <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                     <div className="text-2xl sm:text-3xl font-bold text-white">{selectedVersion.version}</div>
                     <div className="flex flex-wrap gap-2">
                 ...
                 <Card className="bg-zinc-800 border-zinc-700">
                   ...
                   <CardContent>
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label className="text-gray-300 text-sm font-medium">Enlace al repositorio</Label>
                        <div className="flex flex-col sm:flex-row gap-2">
                          <Button
                            size="sm"
                            variant="outline"
                            className="border-zinc-600 text-zinc-300 hover:bg-zinc-700 w-full sm:flex-1"
                            onClick={() => {
                      ...
                      {/* Enlace a CI/CD */}
                      <div className="space-y-2">
                        <Label className="text-gray-300 text-sm font-medium">Enlace a CI/CD</Label>
                        <div className="flex flex-col sm:flex-row gap-2">
                          <Button
                            size="sm"
                            variant="outline"
                      ...
                      <div className="space-y-2">
                        <Label className="text-gray-300 text-sm font-medium">Enlace a documentación</Label>
                        <div className="flex flex-col sm:flex-row gap-2">
                          <Button
                            size="sm"
                            variant="outline"
                      ...
                      {/* Enlace a tickets */}
                      <div className="space-y-2">
                        <Label className="text-gray-300 text-sm font-medium">Enlace a tickets</Label>
                        <div className="flex flex-col sm:flex-row gap-2">
                          <Button
                            size="sm"
                            variant="outline"
                     ...
                     <div className="mt-4 pt-4 border-t border-zinc-600">
                       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                           ...
                           size="sm"
                           variant="ghost"
                           className="text-zinc-300 hover:bg-zinc-700 w-full sm:w-auto"
                           onClick={() => {
                             const { owner, repo } = getGitHubInfo(projectInfo?.github_repository_url);
                             if (owner && repo) {
                ...
                <Tabs defaultValue="overview" className="w-full">
                        ...
                        <CardContent className="space-y-3">
                           <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                            <span className="text-gray-400">Descripción:</span>
                             <span className="text-white text-sm sm:text-base">{selectedVersion.description}</span>
                          </div>
                                                     <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                            <span className="text-gray-400">Build #:</span>
                            <span className="text-white">{selectedVersion.buildNumber}</span>
                          </div>
                                                       <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                            <span className="text-gray-400">Commit:</span>
                             <span className="text-white font-mono text-sm">{selectedVersion.commitHash ? selectedVersion.commitHash.substring(0, 7) : 'N/A'}</span>
                          </div>
                           <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                            <span className="text-gray-400">Branch:</span>
                            <span className="text-white">{selectedVersion.branch || 'main'}</span>
                          </div>
                           <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                            <span className="text-gray-400">Creada:</span>
                            <span className="text-white">{formatDateSafe(selectedVersion.createdAt)}</span>
                          </div>
                          {selectedVersion.deployedAt && (
                             <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                              <span className="text-gray-400">Desplegada:</span>
                              <span className="text-white">{formatDateSafe(selectedVersion.deployedAt)}</span>
                            </div>
                          )}
                        </CardContent>
                      </Card>
                        ...
                        <CardContent className="space-y-3">
                          {(() => {
                            ...
                            return (
                              <>
                                 <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                                  <span className="text-gray-400">Total cambios:</span>
                                  <span className="text-white">{metrics.changesCount}</span>
                                </div>
                                 <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                                  <span className="text-gray-400">Breaking changes:</span>
                                  <span className="text-white">{metrics.breakingChanges}</span>
                                </div>
                                 <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                                  <span className="text-gray-400">Complejidad:</span>
                                  <span className="text-white">{metrics.complexity}</span>
                                </div>
                                 <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                                  <span className="text-gray-400">Tiempo build:</span>
                                  <span className="text-white">{metrics.buildTime}s</span>
                                </div>
                                 <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                                  <span className="text-gray-400">Tamaño:</span>
                                  <span className="text-white">{metrics.size}MB</span>
                                </div>
                                 <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                  ...
                  <TabsContent value="changes" className="space-y-4">
                    <Card className="bg-zinc-800 border-zinc-700">
                      <CardHeader>
                        <CardTitle className="text-white text-lg">Cambios Detallados</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-4">
                  ...
                  <TabsContent value="metrics" className="space-y-4">
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <Card className="bg-zinc-800 border-zinc-700">
                        <CardHeader>
                          <CardTitle className="text-white text-lg">Métricas de Build</CardTitle>
                        </CardHeader>
                      ...
                      <Card className="bg-zinc-800 border-zinc-700">
                        <CardHeader>
                          <CardTitle className="text-white text-lg">Análisis de Riesgo</CardTitle>
                        </CardHeader>
                        <CardContent>
                          {(() => {
                            const metrics = calculateVersionMetrics(selectedVersion);
                            const riskLevel = metrics.risk;
                            const riskColor = riskLevel === 'Alto' ? 'text-red-400' : 
                                            riskLevel === 'Medio' ? 'text-yellow-400' : 'text-green-400';
                  ...
                  <TabsContent value="activity" className="space-y-4">
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <Card className="bg-zinc-800 border-zinc-700">
                        <CardHeader>
                          <CardTitle className="text-white text-lg">Historial de Modificaciones</CardTitle>
                        </CardHeader>
                        <CardContent>
                          <div className="space-y-3">
                            {getVersionHistory(selectedVersion).map((item, index) => (
                              <div key={index} className="flex items-start gap-3 p-3 bg-zinc-700 rounded">
                            ...
                            <div className="space-y-4">
                                 ...
                                 {loadingComments ? (
                                   ...
                                   comments.map((comment) => (
                                     <div key={comment.id} className="p-3 bg-zinc-700 rounded">
                                       <div className="flex items-start gap-2 mb-2">
                                         <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center">
                                           <User className="h-3 w-3 text-white" />
                                         </div>
                                         <div className="flex-1">
                                           <div className="text-sm font-medium text-white">{comment.user_email || 'Usuario'}</div>
                                           <div className="text-xs text-gray-400">
                              ...
                              <div className="space-y-2">
                                <Label htmlFor="newComment" className="text-white">Agregar comentario</Label>
                                 <div className="flex flex-col sm:flex-row gap-2">
                                  <Textarea
                                    id="newComment"
                                    value={newComment}
          ...
          <Dialog open={showWorkflowActions} onOpenChange={setShowWorkflowActions}>
            <DialogContent className="bg-zinc-900 border-zinc-700 max-w-md" aria-describedby="workflow-action-description">
             <DialogHeader>
               <DialogTitle className="text-white">Acción de Workflow</DialogTitle>
             </DialogHeader>
             
             <div className="space-y-4">
               <div>
                 <Label htmlFor="workflowComments" className="text-white">Comentarios (opcional)</Label>
                 <Textarea
                   id="workflowComments"
          ...
          <Dialog open={showRepoModal} onOpenChange={setShowRepoModal}>
            <DialogContent className="bg-zinc-900 border-zinc-700 max-w-md" aria-describedby="repo-config-description">
             <DialogHeader>
               <DialogTitle className="text-white flex items-center gap-2">
             ...
             <div className="space-y-4">
               <div>
                 <Label htmlFor="repositoryUrl" className="text-white">URL del Repositorio</Label>
                 <Input
                   id="repositoryUrl"
                   value={repositoryUrl}
