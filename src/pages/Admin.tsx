    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="space-y-6">
        ...
        {activeSection === 'metricas' && (
          <Card className="bg-zinc-800 border-zinc-700">
            <CardHeader>
              <CardTitle className="text-white">Métricas del Sistema</CardTitle>
              <CardDescription className="text-gray-400">
                Análisis detallado de las métricas del sistema
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                  ...
                  <div className="bg-zinc-700 p-4 rounded-lg">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-green-400">+{usuariosNuevos} este mes</p>
                      </div>
                  ...
                  <div className="bg-zinc-700 p-4 rounded-lg">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-white">{proyectosEnCurso}</p>
                        <p className="text-xs text-blue-400">{tasaCompletacionProyectos}% completados</p>
                      </div>
                  ...
                  <div className="bg-zinc-700 p-4 rounded-lg">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-white">{ticketsAbiertos}</p>
                        <p className="text-xs text-yellow-400">{tasaResolucionTickets}% resueltos</p>
                      </div>
                  ...
                  <div className="bg-zinc-700 p-4 rounded-lg">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-white">${ingresosTotales.toLocaleString()}</p>
                        <p className="text-xs text-green-400">${ingresosEsteMes.toLocaleString()} este mes</p>
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-zinc-700 p-6 rounded-lg">
                    <h3 className="text-lg font-semibold text-white mb-4">Distribución de Proyectos</h3>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-300">En Desarrollo:</span>
                        <Badge variant="secondary">{proyectosEnDesarrollo}</Badge>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-300">Pendientes:</span>
                        <Badge variant="outline">{proyectosPendientes}</Badge>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-300">Completados:</span>
                        <Badge variant="default">{proyectosCompletados}</Badge>
                      </div>
                    </div>
                  </div>
                  <div className="bg-zinc-700 p-6 rounded-lg">
                    <h3 className="text-lg font-semibold text-white mb-4">Estado de Tickets</h3>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-300">Urgentes:</span>
                        <Badge variant="destructive">{ticketsUrgentes}</Badge>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <Badge variant="secondary">{ticketsEnProgreso}</Badge>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-300">Cerrados:</span>
                        <Badge variant="default">{ticketsCerrados}</Badge>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-zinc-700 p-6 rounded-lg">
                  <h3 className="text-lg font-semibold text-white mb-4">Rendimiento del Sistema</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-green-400">{tasaCompletacionProyectos}%</div>
                      <div className="text-sm text-gray-400">Tasa de Completación</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-blue-400">{tasaResolucionTickets}%</div>
                      <div className="text-sm text-gray-400">Tasa de Resolución</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-purple-400">{crecimientoUsuarios}%</div>
                      <div className="text-sm text-gray-400">Crecimiento Usuarios</div>
                    </div>
                  </div>
                </div>
              </div>
