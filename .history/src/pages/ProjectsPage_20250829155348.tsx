...
export default function ProjectsPage() {
  ...
  const handleFilteredProjects = (filtered: any[]) => {
        ...
        {showAnalytics && (
          <div className="bg-white rounded-2xl shadow-lg border border-slate-200/50">
            <div className="p-6 border-b border-slate-200/50">
              <h2 className="text-xl font-semibold text-slate-800">Análisis Avanzado</h2>
            </div>
            <div className="p-6">
              <AdvancedAnalytics />
            </div>
              ...
              <div className="flex flex-col lg:flex-row">
                ...
                <div className="flex-1 p-6 space-y-6 min-w-[300px]">
                  ...
                  <div className="flex gap-2 mt-6">
                    <Button variant="outline" className="flex-1 border-slate-300 text-slate-700 hover:bg-slate-50" onClick={() => navigate(`/proyectos/${selectedProject.id}/colaboracion`)}>
                      <Users className="h-4 w-4 mr-2" /> Colaborar
                    </Button>
                    <Button variant="outline" className="flex-1 border-slate-300 text-slate-700 hover:bg-slate-50" onClick={() => navigate(`/proyectos/${selectedProject.id}`)}>
