      ...
      <div className="flex-1 overflow-hidden">
           <div className="h-full">
            ...
            <div className="relative group cursor-pointer">
                ...
                <div className="bg-white rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-200/50">
                  <div className="text-lg sm:text-xl lg:text-2xl font-bold text-slate-800 mb-2 flex items-center space-x-2 sm:space-x-3">
                    <BarChart3 size={20} className="sm:w-6 sm:h-6 text-amber-600" />
                    <span>Acciones Rápidas</span>
                  </div>
                  <p className="text-slate-500 text-sm sm:text-base mb-4 sm:mb-6 lg:mb-8">
                    Acceso directo a las funciones principales
                  </p>
                  <div className="space-y-4 sm:space-y-6 lg:space-y-10">
                    <Button 
                      variant="outline" 
                      className="w-full justify-start p-3 sm:p-4 lg:p-6 rounded-2xl hover:bg-gradient-to-r hover:from-slate-50 hover:to-slate-100 transition-all duration-300 cursor-pointer group border border-transparent hover:border-slate-200/50 hover:shadow-lg"
                      onClick={() => {
                        setActiveSection('usuarios');
                        window.location.hash = 'usuarios';
                      }}
                    >
                      <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl transition-all duration-300 group-hover:scale-110 bg-blue-100 text-blue-600 group-hover:bg-blue-500 group-hover:text-white mr-3 sm:mr-4 lg:mr-6">
                        <Users size={20} className="sm:w-6 sm:h-6 lg:w-7 lg:h-7" />
                      </div>
                      <span className="text-slate-700 font-bold text-sm sm:text-base lg:text-lg group-hover:text-slate-900 transition-colors duration-300">
                        Gestionar Usuarios
                      </span>
                      <Badge className="ml-auto px-3 py-2 sm:px-4 sm:py-2 lg:px-5 lg:py-3 rounded-2xl text-sm sm:text-base font-bold transition-all duration-300 bg-blue-500 text-white shadow-lg group-hover:bg-blue-600 group-hover:scale-105">
                        {usuariosActivos}
                      </Badge>
                    </Button>
                    <Button 
                    ...
                    >
                      <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl transition-all duration-300 group-hover:scale-110 bg-emerald-100 text-emerald-600 group-hover:bg-emerald-500 group-hover:text-white mr-3 sm:mr-4 lg:mr-6">
                        <FolderOpen size={20} className="sm:w-6 sm:h-6 lg:w-7 lg:h-7" />
                      </div>
                      <span className="text-slate-700 font-bold text-sm sm:text-base lg:text-lg group-hover:text-slate-900 transition-colors duration-300">
                        Ver Proyectos
                      </span>
                      <Badge className="ml-auto px-3 py-2 sm:px-4 sm:py-2 lg:px-5 lg:py-3 rounded-2xl text-sm sm:text-base font-bold transition-all duration-300 bg-emerald-500 text-white shadow-lg group-hover:bg-emerald-600 group-hover:scale-105">
                        {proyectosEnCurso}
                      </Badge>
                    </Button>
                    <Button 
                    ...
                    >
                      <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl transition-all duration-300 group-hover:scale-110 bg-amber-100 text-amber-600 group-hover:bg-amber-500 group-hover:text-white mr-3 sm:mr-4 lg:mr-6">
                        <Ticket size={20} className="sm:w-6 sm:h-6 lg:w-7 lg:h-7" />
                      </div>
                      <span className="text-slate-700 font-bold text-sm sm:text-base lg:text-lg group-hover:text-slate-900 transition-colors duration-300">
                        Revisar Tickets
                      </span>
                      <Badge className="ml-auto px-3 py-2 sm:px-4 sm:py-2 lg:px-5 lg:py-3 rounded-2xl text-sm sm:text-base font-bold transition-all duration-300 bg-amber-500 text-white shadow-lg group-hover:bg-amber-600 group-hover:scale-105">
                        {ticketsAbiertos}
                      </Badge>
                    </Button>
                    <Button 
                    ...
                    >
                      <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl transition-all duration-300 group-hover:scale-110 bg-violet-100 text-violet-600 group-hover:bg-violet-500 group-hover:text-white mr-3 sm:mr-4 lg:mr-6">
                        <CreditCard size={20} className="sm:w-6 sm:h-6 lg:w-7 lg:h-7" />
                      </div>
                      <span className="text-slate-700 font-bold text-sm sm:text-base lg:text-lg group-hover:text-slate-900 transition-colors duration-300">
                        Gestionar Pagos
                      </span>
                      <Badge className="ml-auto px-3 py-2 sm:px-4 sm:py-2 lg:px-5 lg:py-3 rounded-2xl text-sm sm:text-base font-bold transition-all duration-300 bg-violet-500 text-white shadow-lg group-hover:bg-violet-600 group-hover:scale-105">
                        {pagos.length}
                      </Badge>
                    </Button>
                    <Button 
                    ...
                    >
                      <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl transition-all duration-300 group-hover:scale-110 bg-indigo-100 text-indigo-600 group-hover:bg-indigo-500 group-hover:text-white mr-3 sm:mr-4 lg:mr-6">
                        <BarChart3 size={20} className="sm:w-6 sm:h-6 lg:w-7 lg:h-7" />
                      </div>
                      <span className="text-slate-700 font-bold text-sm sm:text-base lg:text-lg group-hover:text-slate-900 transition-colors duration-300">
                        Analytics Avanzado
                      </span>
                      <Badge className="ml-auto px-3 py-2 sm:px-4 sm:py-2 lg:px-5 lg:py-3 rounded-2xl text-sm sm:text-base font-bold transition-all duration-300 bg-indigo-500 text-white shadow-lg group-hover:bg-indigo-600 group-hover:scale-105">
                        <BarChart3 size={14} className="sm:w-4 sm:h-4 lg:w-4 lg:h-4" />
                      </Badge>
                    </Button>
                  </div>
                </div>
