            ...
            {selectedProject && (
              <div className="space-y-6">
                ...
                <div className="border-b border-slate-200 pb-4">
                  ...
                  <p className="text-slate-600 mt-2">{selectedProject.description || 'Sin descripción'}</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-slate-500">Tipo:</span>
                          <span className="font-medium">{selectedProject.type || 'Sin tipo'}</span>
                        </div>
                        <div className="flex justify-between">
                    ...
                    <div>
                      <h3 className="font-semibold text-slate-700 mb-2">Fases del Proyecto</h3>
                      {selectedProject.fases && selectedProject.fases.length > 0 ? (
                        <div className="space-y-2">
                          {selectedProject.fases.map((fase: any, index: number) => (
                            <div key={index} className="flex items-center justify-between p-2 bg-slate-50 rounded-lg">
                              ...
                              <Badge variant={fase.estado === 'Terminado' ? 'default' : 'secondary'}>
                                {fase.estado}
                              </Badge>
                            </div>
                          ))}
                        ...
                        <p className="text-slate-500 text-sm">No hay fases definidas</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="font-semibold text-slate-700 mb-2">Funcionalidades</h3>
                      {selectedProject.funcionalidades && selectedProject.funcionalidades.length > 0 ? (
                        <div className="space-y-2">
                          {selectedProject.funcionalidades.map((func: any, index: number) => (
                            <div key={index} className="p-2 bg-slate-50 rounded-lg">
                              <span className="text-sm font-medium">{func.nombre}</span>
                              {func.descripcion && (
                                <p className="text-xs text-slate-500 mt-1">{func.descripcion}</p>
                              )}
                            </div>
                          ))}
                        </div>
                      ) : (
                        <p className="text-slate-500 text-sm">No hay funcionalidades definidas</p>
                      )}
                    </div>

                    <div>
                      <h3 className="font-semibold text-slate-700 mb-2">Fechas</h3>
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span>{formatDateSafe(selectedProject.updatedAt)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="border-t border-slate-200 pt-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm font-medium text-slate-700">{calculateProjectProgress(selectedProject)}%</span>
                  </div>
                  <Progress value={calculateProjectProgress(selectedProject)} className="h-3" />
                </div>
                  ...
                  {user?.role !== 'admin' && (
                    <Button
                      onClick={() => {
                        ...
                        handleNavigateToCollaboration(selectedProject.id);
                      }}
                      className="flex-1"
                    >
                      <Users className="h-4 w-4 mr-2" />
