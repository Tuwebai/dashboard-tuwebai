        ...
        <div className="flex items-center gap-4 sm:gap-6 w-full sm:w-auto mb-4 sm:mb-0">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    size="sm"
                    onClick={onMenuClick}
                    className="md:hidden text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-lg transition-all duration-300 flex-shrink-0"
                  >
          ...
          {isAdminPage ? (
            <div className="flex-1 min-w-0">
              ...
              {lastUpdate && (
                <div className="text-xs sm:text-sm text-slate-500 flex items-center space-x-2 mt-2">
            ...
            <div className="relative w-full sm:max-w-xs lg:max-w-md">
              ...
              <Input
                ...
                className="pl-10 sm:pl-12 bg-slate-50 border-slate-200 text-slate-900 placeholder:text-slate-500 text-sm sm:text-base rounded-lg focus:ring-2 focus:ring-blue-500/50 focus:border-border transition-all duration-300 hover:bg-slate-100"
              />
            </div>
          )}
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 w-full sm:w-auto">
          ...
          {isAdminPage ? (
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      className="w-full sm:w-auto bg-white border-slate-300 text-slate-700 hover:bg-slate-50 hover:border-slate-400 transition-all duration-300"
                    >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 w-full sm:w-auto">
              ...
              {/* Notificación */}
              <div className="relative w-full sm:w-auto">
                <Button variant="ghost" size="sm" className="relative p-2 w-full sm:w-auto">
              ...
              {onClientRefresh && (
                <Button
                  ...
                  className="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition-all duration-300 shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
                >
                  <RefreshCw className="h-4 w-4 mr-2" />
                  Actualizar
                </Button>
