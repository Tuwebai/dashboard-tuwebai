...
export default function FileManager({ projectId, isAdmin }: FileManagerProps) {
  ...
  const getFilePreviewUrl = async (file: ProjectFile): Promise<string> => {
    try {
      ...
      // CORRECCIÓN: Usar file.path completo que incluye el nombre real del archivo con timestamp
      // file.path contiene: projectId/nombre_completo_del_archivo_con_timestamp
