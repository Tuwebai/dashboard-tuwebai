  ...
  const handleNotificationClick = async (notification: Notification) => {
    try {
      ...
      if (notification.action_url) {
        ...
        console.log('🔔 [NotificationBell] No hay action_url, determinando acción por categoría:', notification.category);
        ...
        switch (notification.category) {
          case 'project':
            ...
            if (notification.metadata?.project_id) {
              // Determinar si es admin o cliente basándose en el contexto
              // Por ahora, asumimos que si estamos en el componente NotificationBell del admin, es para admin
              window.location.href = `/proyectos/${notification.metadata.project_id}/colaboracion-admin`;
            }
            break;
          case 'ticket':
