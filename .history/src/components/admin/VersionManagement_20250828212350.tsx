        ...
        <Dialog open={showVersionDetails} onOpenChange={setShowVersionDetails}>
            ...
            <DialogHeader className="relative">
              ...
              <button
                ...
                className="absolute top-3 right-3 h-6 w-6 flex items-center justify-center text-slate-500 hover:text-slate-700 hover:bg-slate-100 rounded transition-colors"
                aria-label="Cerrar"
              >
