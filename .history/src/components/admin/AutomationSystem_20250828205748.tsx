      ...
      {/* Tabs principales */}
       <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="flex flex-wrap w-full bg-white border border-slate-200 gap-1 p-1 rounded-lg shadow-sm">
          ...
          <TabsTrigger 
            value="tasks" 
            className="text-sm font-medium text-slate-600 hover:text-slate-800 hover:bg-slate-50 data-[state=active]:bg-blue-50 data-[state=700 data-[state=active]:border-blue-200"
          >
            Tareas
          </TabsTrigger>
          <TabsTrigger 
