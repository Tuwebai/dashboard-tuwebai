            ...
            <DialogHeader className="relative">
              <DialogTitle className="text-slate-800 flex items-center gap-2 pr-8">
                ...
                Detalles de Versión {selectedVersion?.version}
                 ...
                 className="absolute top-1 right-1 h-8 w-8 flex items-center justify-center text-slate-500 hover:text-slate-700 hover:bg-slate-100 rounded transition-colors"
                 aria-label="Cerrar"
               >
