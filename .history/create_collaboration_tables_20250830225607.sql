...
-- Primero eliminar las tablas si existen para evitar conflictos
...
CREATE INDEX idx_project_messages_sender ON public.project_messages(sender);
...
CREATE INDEX idx_project_tasks_assignee ON public.project_tasks(assignee);
...
CREATE INDEX idx_project_files_uploaded_at ON public.project_files(uploaded_at);
